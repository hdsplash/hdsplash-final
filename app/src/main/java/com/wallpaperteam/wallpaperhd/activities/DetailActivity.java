...
import com.wallpaperteam.wallpaperhd.fragments.DirectoryChooserFragment;
import com.wallpaperteam.wallpaperhd.fragments.ImagesFragment;
import com.wallpaperteam.wallpaperhd.models.MyImage;
import com.wallpaperteam.wallpaperhd.other.CustomAnimatorListener;
import com.wallpaperteam.wallpaperhd.other.CustomTransitionListener;
...
public class DetailActivity extends AppCompatActivity {
    ...
    private MyImage mSelectedImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.wallpaperteam.wallpaperhd.R.layout.activity_detail);

        findViewById(com.wallpaperteam.wallpaperhd.R.id.container).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        mSelectedImage = (MyImage) getIntent().getSerializableExtra("selected_image");
        ...
        final ImageView image = (ImageView) findViewById(com.wallpaperteam.wallpaperhd.R.id.activity_detail_image);
        ...
        if (!sp.getBoolean("help-understand", false)) {
            Snackbar.with(getApplicationContext())
                    .text(com.wallpaper.wallpaperhd.R.string.help_try_long_click)
                    .actionLabel(com.wallpaper.wallpaperhd.R.string.help_try_long_click_ok)
                    .actionColorResource(com.wallpaper.wallpaperhd.R.color.accent)
...
//        mFabDownloadButton.getAnimation().setAnimationListener(new Animation.AnimationListener() {
//            @Override
...
//        });
    ...
    private void runTourGuide(){
        CustomApplication.sharedPreferences.edit().putBoolean("firstShowcaseView", true).commit();
        //fuck = true;
        showcaseView = new ShowcaseView.Builder(DetailActivity.this)
                .withMaterialShowcase()
                .setTarget(new ViewTarget(findViewById(R.id.activity_detail_fab_download)))
                .setStyle(R.style.CustomShowcaseTheme)
                .setContentTitle(R.string.download_showcase_title)
                .setContentText(R.string.download_showcase_content)
                .setOnClickListener(showCaseClickListener)
                .build();
        showcaseView.setButtonText("Next");
    }

    View.OnClickListener showCaseClickListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            switch (count){
                case 0:
                    showcaseView.setShowcase(new ViewTarget(mFabShareButton), true);
                    showcaseView.setContentTitle(getText(R.string.share_showcase_title));
                    showcaseView.setContentText(getText(R.string.share_showcase_content));
                    break;
                case 1:
                    showcaseView.setShowcase(new ViewTarget(mFabButton), true);
                    showcaseView.setContentTitle(getText(R.string.set_showcase_title));
                    showcaseView.setContentText(getText(R.string.set_showcase_content));
        ...
        public void onClick(View v) {
            if (future == null) {
                if (!Utils.isExternalStorageWritable()) {
                    Toast.makeText(DetailActivity.this, com.wallpaperteam.wallpaperhd.R.string.error_no_storage, Toast.LENGTH_SHORT).show();
                    return;
                }
            ...
            /*SimpleHintContentHolder blockInfo =
                    new SimpleHintContentHolder.Builder(v.getContext())
                    ...
                    if (e == null && result != null && result.getResult() != null) {
                        try {
                            ...
                            if (TextUtils.isEmpty(customLocation)) {
                                ...
                                dir = Utils.getAlbumStorageDir("WallpaperHD");
                            } else {
    ...
    private void animateActivityStart() {
        ...
        showTitleAnimator.setListener(new CustomAnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                super.onAnimationEnd(animation);
                mTitlesContainer.startAnimation(AnimationUtils.loadAnimation(DetailActivity.this, com.wallpaperteam.wallpaperhd.R.anim.alpha_on));
                ...
                mFabDownloadButton.animate()
                        ...
                        .setListener(new Animator.AnimatorListener() {
                            ...
                            @Override
                            public void onAnimationEnd(Animator animation) {
                                if (!CustomApplication.sharedPreferences.getBoolean("firstShowcaseView", false))
                                    runTourGuide();
                            }
    ...
    private void setColors(int titleTextColor, int rgb) {
        ...
        TextView titleTV = (TextView) mTitleContainer.findViewById(com.wallpaperteam.wallpaperhd.R.id.activity_detail_title);
        titleTV.setTextColor(titleTextColor);
        titleTV.setText(mSelectedImage.getAuthor());

        TextView subtitleTV = (TextView) mTitleContainer.findViewById(com.wallpaperteam.wallpaperhd.R.id.activity_detail_subtitle);
        subtitleTV.setTextColor(titleTextColor);
        //subtitleTV.setText(mSelectedImage.getReadableModified_Date());

        ((TextView) mTitleContainer.findViewById(com.wallpaperteam.wallpaperhd.R.id.activity_detail_subtitle))
